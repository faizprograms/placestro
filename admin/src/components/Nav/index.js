  ...
  if(user){
    nav_link=(<>
                 <div className="nav_link">
                  <Link onClick={toggle} to="/placestroAdmin/">
                      <p>Home</p>
                  </Link>
                </div>
                 <div className="nav_link">
                  <Link onClick={toggle} to="/placestroAdmin/companies">
                      <p>Companies</p>
                  </Link>
                </div>
                 <div className="nav_link">
                  <Link onClick={toggle} to="/placestroAdmin/users">
                      <p>Users</p>
                  </Link>
                </div>
                <div className="nav_link">
                  <Link onClick={toggle} to="/placestroAdmin/user/profile">
